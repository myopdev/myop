...
If0 = [ observation = noncoding_model
        sequence_length = $intron_short_length ]
I1 = [ observation = noncoding_model ]
Is1 = [ observation = noncoding_model
        duration = intron_length ]
If1 = [ observation = noncoding_model
        sequence_length = $intron_short_length ]
I2 = [ observation = noncoding_model ]
Is2 = [ observation = noncoding_model
        duration = intron_length ]
If2 = [ observation = noncoding_model
        sequence_length = $intron_short_length ]
rI0 = [ observation = noncoding_model ]
rIs0 = [ observation = noncoding_model
        duration = intron_length ]
rIf0 = [ observation = noncoding_model
        sequence_length = $intron_short_length ]
rI1 = [ observation = noncoding_model ]
rIs1 = [ observation = noncoding_model
         duration = intron_length ]
rIf1 = [ observation = noncoding_model
        sequence_length = $intron_short_length ]
rI2 = [ observation = noncoding_model ]
rIs2 = [ observation = noncoding_model
        duration = intron_length ]
rIf2 = [ observation = noncoding_model
       sequence_length = $intron_short_length ]
...
rdon2 = [ observation = rdonor_model
          sequence_length = $donor_signal_length ]
EOF
open (GHMM, ">ghmm/model/ghmm_intron_short_nostop.model") or die "model/ghmm_intron_short_nostop.model: $!";
print GHMM $ghmm;
close(GHMM);
...
open (GHMM, "<ghmm/model/ghmm_intron_short_nostop.model") or die "$!";
my $reading_trans = 0;
...
system("rm ghmm/model/ghmm_intron_short_nostop.model");
system("mv ghmm/model/ghmm_final.model ghmm/model/ghmm_intron_short_nostop.model");
